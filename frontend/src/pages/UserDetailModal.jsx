      ...
      {!editando ? (
                  ...
                  {movimientos.map(mov => movEdit && movEdit.id === mov.id ? (
                    <tr key={mov.id}>
                      ...
                      <td>
                        ...
                        <button className="admin-btn" onClick={() => setMovEdit(null)} disabled={movGuardando}>
                          Cancelar
                        </button>
                      </td>
                    </tr>
          ...
          {movAEliminar && (
            ...
            >
              ...
              <div className="admin-modal-actions">
                ...
                <button className="admin-btn" onClick={() => setMovAEliminar(null)} disabled={movGuardando}>Cancelar</button>
              </div>
            </AdminModal>
          )}
        ...
        <form onSubmit={handleSave}>
          ...
          <div className="admin-modal-actions">
            ...
            <button type="button" className="admin-btn" onClick={handleCancel}>Cancelar</button>
          </div>
        </form>
      )}
    </AdminModal>
